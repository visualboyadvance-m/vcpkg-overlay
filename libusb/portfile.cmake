...
vcpkg_from_github(
    ...
    HEAD_REF master
    PATCHES
        # msvc/Base.props turns on /GL, which vcpkg cannot switch off: its
        # vcpkg_msbuild_install guard passes /p:WholeProgramOptimization=false,
        # a global property, while Base.props sets the same name as ClCompile
        # item metadata, which no global property reaches.  The result is a
        # static lib full of LTCG IL, and IL is only readable by the compiler
