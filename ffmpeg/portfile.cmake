...
if(VCPKG_TARGET_IS_UWP)
    ...
    string(APPEND OPTIONS " --extra-cflags=-DWINAPI_FAMILY=WINAPI_FAMILY_APP --extra-cflags=-D_WIN32_WINNT=0x0501")
...
if(VCPKG_TARGET_IS_MINGW)
    set(OPTIONS "${OPTIONS} --disable-w32threads --enable-pthreads --extra_cflags=-D_WIN32_WINNT=0x0501")
elseif(VCPKG_TARGET_IS_WINDOWS)
